...
/**
 * This is a configuration class of redis utilities.
 * @param <T>
 */
@Configuration
public class RedisUtil<T> {
    ...
    @Autowired
    public RedisUtil(@Qualifier("redisTemplate") RedisTemplate<String, T> redisTemplate) {
    ...
    public void removeMap(String redisKey, Object key, T data) {
